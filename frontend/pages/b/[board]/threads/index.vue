  ...
  <div>
    ...
    <div v-else-if="!loading" class="bg-white border border-gray-200 rounded-lg overflow-hidden divide-y divide-gray-100">
      ...
      >
        ...
        <!-- Last activity -->
        <div class="shrink-0 text-right min-w-[80px] hidden sm:block">
          <div class="text-xs text-gray-500">
            {{ formatTime(thread.updatedAt || thread.createdAt) }}
          </div>
          <div class="text-[10px] text-gray-400">last activity</div>
        </div>
      </NuxtLink>
    </div>
