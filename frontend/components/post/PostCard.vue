  ...
  <article class="bg-white border border-gray-200 rounded-lg hover:border-gray-300 hover:shadow-xs transition-all duration-150 group">
    ...
    <template v-if="compact">
      <div class="flex items-center gap-2 px-3 py-2.5 sm:py-2">
        ...
        <!-- Pinned -->
        <svg v-if="post.isFeaturedBoard" class="w-3.5 h-3.5 text-green-500 shrink-0" fill="currentColor" viewBox="0 0 16 16">
          <path d="M4.146.146A.5.5 0 014.5 0h7a.5.5 0 01.5.5c0 .68-.342 1.174-.646 1.479-.126.125-.25.224-.354.298v4.431l.078.048c.203.127.476.314.751.555C12.36 7.775 13 8.527 13 9.5a.5.5 0 01-.5.5H8.5v5.5a.5.5 0 01-1 0V10H3.5a.5.5 0 01-.5-.5c0-.973.64-1.725 1.17-2.189a5.1 5.1 0 01.83-.602v-4.43a2.5 2.5 0 01-.354-.298C4.342 1.674 4 1.179 4 .5a.5.5 0 01.146-.354z" />
        </svg>
