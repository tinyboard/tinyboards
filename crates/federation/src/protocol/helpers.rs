...
/// }
///
/// let single: Note = serde_json::from_str(r#"{"to": "https://example.com/@alice" }"#)?;
/// assert_eq!(single.to.len(), 1);
///
/// let multiple: Note = serde_json::from_str(
/// r#"{"to": [
///      "https://example.com/@alice",
///      "https://tinyboards.net/@bob"
/// ]}"#)?;
...
/// }
///
/// let note = serde_json::from_str::<Note>(r#"{"to": ["https://example.com/@alice"] }"#);
/// assert!(note.is_ok());
