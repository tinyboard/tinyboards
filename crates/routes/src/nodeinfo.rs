...
async fn node_info(context: web::Data<TinyBoardsContext>) -> Result<HttpResponse, Error> {
    ...
    let open_registrations = Some(site_view.local_site.open_registration == true);
    let json = NodeInfo {
