...
// };
// use tinyboards_utils::{claims::Claims, error::TinyBoardsError, parser::parse_markdown};
...
//   channel_builder
//     .namespaces(RSS_NAMESPACE.clone())
//     .title(&format!("{} - {}", site_view.site.name, board.name))
//     .link(board.actor_id.to_string())
//     .items(items);

//   if let Some(board_desc) = board.description {
//     channel_builder.description(&board_desc);
//   }
...
//   protocol_and_hostname: &str,
// ) -> Result<Vec<Item>, TinyBoardsError> {
...
//   let guid = GuidBuilder::default().permalink(true).value(url.to_string()).build();
//   i.guid(Some(guid));
//   i.link(url.to_owned());
//   // TODO add images
...
//     let board_url = format!("{}/+{}", protocol_and_hostname, p.board.name);

//     // TODO add images
//     let mut description = format!("submitted by <a href=\"{}\">{}</a> to <a href=\"{}\">{}</a><br>{} points | <a href=\"{}\">{} comments</a>",
//     p.creator.unwrap().actor_id,
//     p.creator.unwrap().name,
//     board_url,
//     p.board.name,
//     p.counts.score,
//     post_url,
