...
impl ActivityHandler for LockPage {
  ...
  async fn receive(self, context: &Data<Self::DataType>) -> Result<(), Self::Error> {
    let form = PostForm { is_locked: Some(true), updated: Some(naive_now()), ..PostForm::default()};
...
impl ActivityHandler for UndoLockPage {
  ...
  async fn receive(self, context: &Data<Self::DataType>) -> Result<(), Self::Error> {
    ...
    let form = PostForm { is_locked: Some(false), updated: Some(naive_now()), ..PostForm::default()};
