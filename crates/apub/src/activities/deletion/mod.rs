use crate::{
    activities::{
        board::send_activity_in_board, verify_is_public, verify_mod_action, verify_person_in_board,
    },
    activity_lists::AnnouncableActivities,
    objects::{board::ApubBoard, comment::ApubComment, person::ApubPerson, post::ApubPost},
    protocol::{
...
use tinyboards_db::{
    models::{
        board::boards::Board, comment::comments::Comment, person::person::Person, post::posts::Post,
    },
    traits::Crud,
};
...
impl SendActivity for DeleteComment {
    ...
    async fn send_activity(
        ...
        send_apub_delete_in_board(person, board, deletable, None, request.deleted, context).await
    }
}
