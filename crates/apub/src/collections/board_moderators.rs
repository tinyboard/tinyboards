...
use tinyboards_federation::{
    ...
    traits::Collection, protocol::verification::verify_domains_match,
};
use tinyboards_api_common::{data::TinyBoardsContext, utils::generate_moderators_url};
use tinyboards_db::{
    models::board::board_mods::*,
    traits::Joinable,
};
...
impl Collection for ApubBoardModerators {
  ...
  async fn from_json(
    ...
    let current_moderators =
      BoardModeratorView::for_board(data.pool(), community_id).await?;
