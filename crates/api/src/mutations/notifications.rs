...
pub struct UpdateNotificationSettingsInput {
    ...
    pub post_votes_enabled: Option<bool>,
    pub comment_votes_enabled: Option<bool>,
...
impl NotificationMutations {
    ...
    pub async fn update_notification_settings(
        ...
        let form = NotificationSettingsForm {
            ...
            post_votes_enabled: input.post_votes_enabled,
            comment_votes_enabled: input.comment_votes_enabled,
        ...
        match DbNotificationSettings::update(pool, user.id, &form).await {
            Ok(updated_settings) => Ok(UpdateNotificationSettingsResponse {
                ...
                settings: NotificationSettingsOutput {
                    ...
                    comment_replies_enabled: updated_settings.comment_replies_enabled,
                    post_replies_enabled: updated_settings.post_replies_enabled,
                    mentions_enabled: updated_settings.mentions_enabled,
                    post_votes_enabled: updated_settings.post_votes_enabled,
                    comment_votes_enabled: updated_settings.comment_votes_enabled,
                    private_messages_enabled: updated_settings.private_messages_enabled,
                    board_invites_enabled: updated_settings.board_invites_enabled,
                    moderator_actions_enabled: updated_settings.moderator_actions_enabled,
                    system_notifications_enabled: updated_settings.system_notifications_enabled,
                },
            }),
            Err(e) => Err(e.into()),
        }
