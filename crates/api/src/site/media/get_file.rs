...
// use crate::Perform;
// use actix_web::{HttpResponse, web::Data, http::header::ContentType, body::BodyStream};
...
//                 let image = image::open(&path).map_err(|e| TinyBoardsError::from_error_message(e, 500, "internal server error"))?;
...
//                     } else {
//                         image = image.resize(width, image.height(), image::imageops::FilterType::Lanczos3);
//                     }
//                 }
