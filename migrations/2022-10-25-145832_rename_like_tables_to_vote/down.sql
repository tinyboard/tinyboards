...
-- drop the aggregate tables & assosciated triggers
drop table user_aggregates;
drop trigger user_aggregates_post_score on post_vote;
drop trigger user_aggregates_comment_score on comment_vote;
drop function user_aggregates_post_score, user_aggregates_comment_score;

drop table post_aggregates;
drop trigger post_aggregates_score on post_vote;
drop function post_aggregates_score;

drop table comment_aggregates;
drop trigger comment_aggregates_score on comment_vote;
drop function comment_aggregates_score;

-- drop the indexes
drop index idx_post_vote_post;
drop index idx_post_vote_user;
drop index idx_comment_vote_comment;
drop index idx_comment_vote_user;

-- change the table names
alter table post_vote rename to post_like;
alter table comment_vote rename to comment_like;
