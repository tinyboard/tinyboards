-- Revert trigger functions back to using 'updated_at' and 'created_at'
-- This reverts the standardization to 'updated' and 'creation_date'
...
BEGIN
    IF (TG_OP = 'INSERT') THEN
        -- Create aggregate record for new flair template (use created_at and updated_at)
