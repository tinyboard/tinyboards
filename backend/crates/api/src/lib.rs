...
use crate::mutations::{
    ...
    flair_categories::MutationFlairCategories,
    ...
    wiki::{CreateWikiPage, WikiPageActions},
};
use async_graphql::*;
use queries::{
...
impl PostgresLoader {
    pub fn new(pool: &DbPool, my_user_id: uuid::Uuid) -> Self {
        Self {
            pool: pool.clone(),
            my_user_id,
        }
...
impl LoggedInUser {
    ...
    pub(crate) async fn require_user_approved(&self, _pool: &DbPool) -> Result<&User> {
