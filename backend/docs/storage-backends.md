...
The configuration (`tinyboards.hjson` in the project root) is already set up for storage backends. To use cloud storage:

1. **Uncomment** the desired backend in `tinyboards.hjson`
